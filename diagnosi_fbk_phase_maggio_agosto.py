"""
MarketSentinel
DIAGNOSI FINECO PHASE - MAGGIO/AGOSTO 2026

Solo diagnostica.
NON modifica alcun file di produzione.

Obiettivo:
capire settimana per settimana perché Fineco viene classificata
...
def main():
    ...
    # =========================================================
    # SOLO MAGGIO - AGOSTO 2026
    # =========================================================

    z = g[
        (g["Date"] >= pd.Timestamp("2026-05-01", tz="UTC"))
        &
        (g["Date"] <= pd.Timestamp("2026-08-31", tz="UTC"))
    ].copy()
    ...
    wanted = [
        ...
        # eventuali indicatori disponibili
        "RSI",
        "RSI_14",
        "MACD",
        "MACD_SIGNAL",
    ...
    print("\n" + "=" * 180)
    print("FINECO - DIAGNOSI PHASE MAGGIO/AGOSTO 2026")
    print("=" * 180)
    ...
    print("\n" + "=" * 180)
    print("COLONNE HA / BB / RSI / MACD / VOLUME DISPONIBILI")
    print("=" * 180)
